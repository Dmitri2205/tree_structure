...
export const Properties = () => {
  ...
  const spanReset = (
    ...
    span.onclick = (e): void =>
      editPropertiesHandler(property, e.currentTarget, childIndex, tabName);
  ...
  const createTabs = (): Array<ReactNode> => {
  ...
  const loadHandler = (): void => {
    ...
    const textFile = new Blob([JSON.stringify(elements)], {
      ...
      <Modal show={showModal}>
        ...
        <Modal.Footer>
          ...
          >
            ...
            <input
              type="file"
              className="visually-hidden position-absolute w-100 h-100 top-0 start-0"
